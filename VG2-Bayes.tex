...
Using NHST for these designs creates a perverse incentive to underpower studies, as the larger the sample size, the more likely it becomes that a significant effect will be found. An underpowered study will almost always indicate that two games have no significant differences, or that an effect of violent games could not be detected. In some cases, statistical power can be futher reduced by the application of harsh multiple comparison corrections. This inferential approach, then, implicitly and subtly rewards researchers for collecting insufficient data by yielding the desired research conclusion.
