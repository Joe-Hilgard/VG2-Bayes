...
1/equivTestPaired(20, 1.67, c(-.1, .1)) #Discomfort
1/equivTestPaired(20, 1.56, c(-.1, .1)) #Realism
1/equivTestPaired(20, 1.32, c(-.1, .1)) #Frustration
1/equivTestPaired(20, 1.29, c(-.1, .1)) #Pleasure
1/equivTestPaired(20, 1.24, c(-.1, .1)) #Action
1/equivTestPaired(20, 1.14, c(-.1, .1)) #Disorientation
1/equivTestPaired(20, .89, c(-.1, .1)) #Excitement
1/equivTestPaired(20, .86, c(-.1, .1)) #Identification
1/equivTestPaired(20, .83, c(-.1, .1)) #Satisfaction
1/equivTestPaired(20, .79, c(-.1, .1)) #Boredom
1/equivTestPaired(20, .53, c(-.1, .1)) #Presence
1/equivTestPaired(20, .48, c(-.1, .1)) #Involvement
...
1/equivTestPaired(14, -sqrt(0.21), c(-.1, .1))  # Competition
1/equivTestPaired(14, sqrt(0.35), c(-.1, .1))   # Difficulty
1/equivTestPaired(14, sqrt(0.64), c(-.1, .1))   # Pace

# experiment 1, 21 subs in 2 cells each
equivTest(21, 21, sqrt(61.75), c(-.1, .1))  # Violence
1/equivTest(21, 21, -sqrt(0.15), c(-.1, .1))  # Competition
1/equivTest(21, 21, -sqrt(2.54), c(-.1, .1))  # Difficulty
1/equivTest(21, 21, -sqrt(2.56), c(-.1, .1))  # Pace 
